...
<link href="bower_components/font-awesome/css/font-awesome.min.css"
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
        ...
        <div class="container-fluid">
		   ...
		   <script type="text/javascript">
			...
			<div class="col-lg-4">
			<input  class="form-control" name="USN" required="required" value="<?php echo $row['usn']; ?>" pattern="1BM[0-9][0-9]MCA[0-9][0-9]" disabled>
			</div>
			</div>	
			<br><br>
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
			<input class="form-control" name="proctor" required="required"  value="<?php echo $row['proctor']; ?>" disabled>
			</div> 
			  <br>
 ...
 <tr> 
                  ...
                  <td><div class="col-lg-6">
			<input class="form-control" name="degreeboard" required="required" value="<?php echo $row['degree']; ?>" pattern="[A-Za-z]+$">
			</div></td>
            <td><div class="col-lg-6">
			<input class="form-control" name="degreemarks" required="required" value="<?php echo $row['degreemarks']; ?>" pattern="[0-9][0-9]">
			</div></td>
			<td><div class="col-lg-6">
			<input class="form-control" name="degreeyear" required="required" value="<?php echo $row['yopdegree']; ?>" pattern="[1-2][0-9][0-9][0-9]">
			</div></td>
                  </tr>
...
else
{
	...
	<div class="panel panel-default">
			...
			<div class="col-lg-4">
			<input  class="form-control" name="USN" required="required" value="<?php echo $usn10; ?>" pattern="1BM[0-9][0-9]MCA[0-9][0-9]" disabled>
			</div>
			</div>	
			<br><br>
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
			<select id="proctor" name="proctor">                      
