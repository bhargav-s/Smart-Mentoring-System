					  ...
					  <!-- block -->
                        <div id="block_bg" class="block">
							...
							<h1 align="center">INTERNAL ASSESSMENT FOR 1ST YEAR</h1>
                                <div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i><?php echo $row['usn']; ?> </div>
...
<?php
            ...
            <!-- /.panel-heading -->
			 ...
			 <th>Subject Code</th>
                                         ...
                                         <div class="col-lg-7">
			<th><input class="form-control" name="sc11" value="<?php echo $row['sc1']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>   
            <div class="col-lg-7">
			<th><input class="form-control" name="sc21" value="<?php echo $row['sc2']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>   
              <div class="col-lg-6">
			 <th><input class="form-control" name="sc31" value="<?php echo $row['sc3']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>
<div class="col-lg-6">
			 <th><input class="form-control" name="sc41" value="<?php echo $row['sc4']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc51" value="<?php echo $row['sc5']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc61" value="<?php echo $row['sc6']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc71" value="<?php echo $row['sc7']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc81" value="<?php echo $row['sc8']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th> Total	</th>
			</div> 			
...
<div class="row">
            ...
            <!-- /.panel-heading -->
			 ...
			 <th>Subject Code</th>
                                         ...
                                         <div class="col-lg-6">
			<th><input class="form-control" name="sc12" value="<?php echo $row['sc11']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>   
            <div class="col-lg-6">
			<th><input class="form-control" name="sc22" value="<?php echo $row['sc21']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>   
              <div class="col-lg-6">
			 <th><input class="form-control" name="sc32" value="<?php echo $row['sc31']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div>
<div class="col-lg-6">
			 <th><input class="form-control" name="sc42" value="<?php echo $row['sc41']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc52" value="<?php echo $row['sc51']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc62" value="<?php echo $row['sc61']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc72" value="<?php echo $row['sc71']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th><input class="form-control" name="sc82" value="<?php echo $row['sc81']; ?>" pattern="13[Mm][Cc][Aa][0-9][0-9]" title="Subject code should be like. e.g. 13mca11">	</th>
			</div> 
<div class="col-lg-6">
			 <th> Total	</th>
			</div> 			
