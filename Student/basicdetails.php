...
<link href="bower_components/font-awesome/css/font-awesome.min.css"
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
			<select id="pro" name="proctor" >                      
			<option value="<?php echo $row['proctor'];?>"><?php echo $row['proctor'];?></option>
			
			<option value="VK">Dr K Vijayakumar</option>
			<option value="GK">Girish K</option>
			<option value="PLN">Lakshminarayana P</option>
			<option value="VPP">Padmapriya V</option>
			<option value="TSP">Pushpa T S</option>
			<option value="RR">Raghavendra Rao R V</option>
			<option value="RMR">Rammohan Reddy C H</option>
			<option value="SS">S Shilpa</option>
			<option value="KPS">Shailaja K P</option>
			<option value="SRK">Sivaramakrishna M</option>
			<option value="US">Uma S</option>
			</select>
			</div> 
 ...
 <tr> 
                  ...
                  <td><div class="col-lg-7">
			<input class="form-control" name="degreeboard" required="required" value="<?php echo $row['degree']; ?>" pattern="[A-Za-z]+$" title="Should be in letters. e.g. deepesh">
			</div></td>
            <td><div class="col-lg-6">
			<input class="form-control" name="degreemarks" required="required" value="<?php echo $row['degreemarks']; ?>" pattern="[0-9][0-9]" title="Should be 2 digits. e.g. 50">
			</div></td>
			<td><div class="col-lg-6">
			<input class="form-control" name="degreeyear" required="required" value="<?php echo $row['yopdegree']; ?>" pattern="[1-2][0-9][0-9][0-9]" title="Should be 4 digits. e.g. 2008">
			</div></td>
                  </tr>
...
$result = mysql_query("select proctor from year1 where usn = '$staff_fullname'");
...
else
{
	...
	$query1 = "UPDATE year1 SET fullname='$fullname',usn='$staff_fullname',DOB='$dob',email='$email',Mobileno='$mobile',address='$fatheroccadd',proctor='$proctor',bloodgroup='$bloodgroup',fathername='$fathername',foccupation='$fatherocc',faddress='$fatheroccadd',fcontact='$fmobileno',mothername='$mothername',moccupation='$motherocc',maddress='$motheroccadd',mcontact='$mmobileno',localname='$guarname',lcontact='$guarmobileno',accommodation='$accommadation',boardx='$xboard',xmarks='$xmarks',yopx='$xyear',boardxii='$xiiboard',xiimarks='$xiimarks',yopxii='$xiiyear',degree='$degreeboard',degreemarks='$degreemarks',yopdegree='$degreeyear',yr='$yr' WHERE usn = '$staff_fullname' ";
	mysql_query($query1);
}
