	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-user"></i> Students Details</a>
                            </li>
							...
							<li>
                            <a href="addStudent.php"><i class="icon-chevron-right"></i><i class="icon-remove-sign"></i>  Add Student
