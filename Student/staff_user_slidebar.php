	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-user"></i> Stundents Details</a>
                            </li>
                            <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Examination</a>
                            </li> 
						    <li>
