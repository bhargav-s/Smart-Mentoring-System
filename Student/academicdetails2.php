...
<?php
								$query = mysql_query("select * from marks2 where usn='$staff_fullname'")or die(mysql_error());
			...
			<div class="panel-heading"><center><b style="color:darkblue">INTERNAL MARKS FOR 5TH SEMESTER</center></div>
...
<div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
			<div class="panel-heading"><center><b style="color:darkblue">PROJECT REPORT FOR 6TH SEMESTER</center></div>
			<div class="panel-body">
			<div class="row">
...
$result = mysql_query("select sc1 from marks2 where usn = '$staff_fullname'");
if(mysql_num_rows($result)==0)
{
mysql_query("INSERT INTO marks2 VALUES('$usn',
'$sc11', 	   
'$sc21', 	   
'$sc31', 	   
'$sc41', 	   
